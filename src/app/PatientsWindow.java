...
public class PatientsWindow extends JFrame {
	...
	private void initialize() {
		...
		// Create components
		title = new JLabel("HASTA BÝLGÝSÝ");
		back = new JButton("< Geri");
		filterByName = new JLabel("Ad ve soyada göre filtrele");
		firstName = new JTextField();
		lastName = new JTextField();
		filterByGender = new JLabel("Cinsiyete göre filtrele:");
		filterByTckn = new JLabel("TCKN'ye göre filtrele:");
		tckn = new JTextField();
		...
		dash1 = new JLabel("-");
		filterByAge = new JLabel("Yaþa göre filtrele:");
		filterByBloodType = new JLabel("Kan grubuna göre filtrele:");
		deletePatient = new JButton("Hastayý sil");
		createPatient = new JButton("Hasta ekle");
		maxAge = new JTextField();
		updatePatient = new JButton("Hasta bilgilerini güncelle");
		filterByCronicalIllnes = new JLabel("Kronik hastalýða göre filtrele:");
		...
		filterByStatus = new JLabel("Durumuna göre filtrele");
		status = new JTextField();
		hospital = new JTextField();
		filterByHospital = new JLabel("Muayene olduðu hastaneye göre filtrele:");
		slash1 = new JLabel("/");
